...
$Page2 = curl "https://inkscape.org/release/inkscape-$LatestWebVersion/windows/64-bit/msi/dl/" -UseBasicParsing
$InstallerName = ($Page2.Links.href -like "*.msi").split("/")[-1]

# Compute download link
# Example: https://media.inkscape.org/dl/resources/file/inkscape-1.3.2_2023-11-25_091e20e-x64.msi
...
RunProcess "C:\Program Files\Inkscape\bin\inkscape.exe" $Null $False
