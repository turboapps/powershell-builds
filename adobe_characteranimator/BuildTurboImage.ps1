...
$Vendor = "Adobe"
$AppDesc = "Animate in real-time — Use your own facial expressions, movements and voice to bring characters to life."
$AppName = "Character Animator"
...
Expand-Archive -Path $DownloadPath\CharacterAnimator_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\CharacterAnimator_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Character Animator"
