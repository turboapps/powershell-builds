...
$Vendor = "MongoDB"
$AppDesc = "Easily explore and manipulate your database with Compass, the GUI for MongoDB."
...
# Copy MongoDB Compass folder to appdata - the general.json file in this folder will disable update checks and CEIP
Copy-Item -Path "$SupportFiles\MongoDB Compass" -Destination "$env:APPDATA" -Recurse -Force
