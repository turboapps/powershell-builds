...
$AppDesc = "The Apache HTTP Server, a secure, efficient and extensible HTTP/1.1 and HTTP/2 web server. 64-bit Apache Lounge build."
$AppName = "Apache HTTP Server x64"
...
$ALArch      = "Win64"                                  # architecture token in the .zip file name
$VcRedistUrl = "https://aka.ms/vc14/vc_redist.x64.exe"  # runtime the VS18 binaries link against
...
$VcRedist = DownloadInstaller $VcRedistUrl $DownloadPath "vc_redist.x64.exe"
