...
$LatestMajorVer = (($Page.Links | Where-Object {$_.href -like "*core*"})[2])
...
$turboCmd = "try winget --isolate=merge -- /C winget install Microsoft.DotNet.SDK.$LatestMajorVer -a x86 --silent --accept-source-agreements"
