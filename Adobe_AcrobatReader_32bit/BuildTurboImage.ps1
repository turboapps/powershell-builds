...
$HubOrg = "adobe/adobereader"  # Set this for each package
$Vendor = "Adobe"
$AppDesc = "View, print, search, sign, verify, and collaborate on PDF documents."
$AppName = "Acrobat Reader (32-bit)"
...
&reg.exe add "HKCU\SOFTWARE\Adobe\Acrobat Reader\DC\AVAlert\cCheckbox" /t REG_DWORD /d 1 /v iAppDoNotTakePDFOwnershipAtLaunchWin10 /f
&reg.exe add "HKCU\SOFTWARE\Adobe\Acrobat Reader\DC\AVAlert\cCheckbox" /t REG_DWORD /d 1 /v iAppDoNotTakePDFOwnershipAtLaunch /f
&reg.exe add "HKCU\SOFTWARE\Adobe\Acrobat Reader\DC\AVAlert\FTEDialog" /t REG_DWORD /d 10 /v iFTEVersion /f
&reg.exe add "HKCU\SOFTWARE\Adobe\Acrobat Reader\DC\AVAlert\FTEDialog" /t REG_DWORD /d 0 /v iLastCardShown /f
&reg.exe add "HKCU\SOFTWARE\Adobe\Acrobat Reader\DC\Privileged" /t REG_DWORD /d 0 /v bProtectedMode /f
