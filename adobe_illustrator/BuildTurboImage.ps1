...
$Vendor = "Adobe"
$AppDesc = "Adobe Illustrator is a vector graphics editor and design program."
$AppName = "Illustrator"
...
$ProcessExitCode = RunProcess "$DownloadPath\Illustrator_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Illustrator"
