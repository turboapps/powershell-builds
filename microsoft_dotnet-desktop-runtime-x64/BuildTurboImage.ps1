...
$AppName = ".NET Desktop Runtime (x64)"
...
$turboCmd = "try winget --isolate=merge -- /C winget install Microsoft.DotNet.DesktopRuntime.$LatestMajorVer -a x64 --silent --accept-source-agreements"
