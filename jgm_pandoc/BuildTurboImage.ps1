...
$Vendor = "jgm"
$AppDesc = "A universal document converter."
$AppName = "pandoc"
$VendorURL = "https://pandoc.org/"
...
$DownloadLink = "https://github.com/jgm/pandoc/releases/download/$latestVersion/pandoc-$latestVersion-windows-x86_64.zip"
...
# Rename versioned pandoc-[vers] to pandoc folder.
# This will also capture the files because it is a change.
. xcopy /s/e/h (Get-Item "C:\pandoc-$latestVersion").FullName C:\pandoc\
...
# pandoc is just a downloaded .exe, it is not installed
