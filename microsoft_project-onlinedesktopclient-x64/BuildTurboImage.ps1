...
$Vendor = "Microsoft"
$AppDesc = "Microsoft Project is a comprehensive task management desktop application for Project Plan 3 and Project Plan 5."
$AppName = "Project Online Desktop Client"
...
$InstalledVersion = GetVersionFromRegistry "Microsoft Project - en-us"
