...
$Vendor = "Adobe"
$AppDesc = "Shoot, edit, and share videos with this free all-in-one video editing app for mobile and desktop."
$AppName = "Premiere Rush"
...
Expand-Archive -Path $DownloadPath\PremiereRush_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\PremiereRush_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
