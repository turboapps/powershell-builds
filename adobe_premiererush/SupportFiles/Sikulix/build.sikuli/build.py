...
type("premiere rush")
click(Pattern("select-app.png").targetOffset(158,-2))
click("next-button.png")
click("next-button.png")
...
adobefile_path = os.path.join(os.environ['USERPROFILE'], "Downloads\\PremiereRush_x64_en_US_WIN_64.zip")
