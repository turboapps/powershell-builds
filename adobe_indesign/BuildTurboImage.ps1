...
$Vendor = "Adobe"
$AppDesc = "Create layout designs. Publish printed books, brochures, digital magazines, flyers, and interactive online documents with Adobe InDesign."
$AppName = "InDesign"
...
Expand-Archive -Path $DownloadPath\InDesign_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\InDesign_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
