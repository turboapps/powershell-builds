...
$Vendor = "Microsoft"
$AppDesc = "WebView2 is a way for app developers to embed web content (such as HTML, JavaScript, and CSS) in Windows applications."
$AppName = "Edge WebView2 Runtime"
$VendorURL = "https://developer.microsoft.com/en-us/microsoft-edge/webview2"
...
$ProcessExitCode = RunProcess $Installer "/silent /install" $True
...
$InstalledVersion = GetVersionFromRegistry "Microsoft Edge WebView2"
