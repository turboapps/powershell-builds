...
if (-not $downloadUrl) {
    WriteLog "No suitable KLayout Windows x64 installer URL was found on the download page."
    throw "Unable to determine the current KLayout Windows x64 installer URL."
}
