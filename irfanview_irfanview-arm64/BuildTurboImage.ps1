...
# The ARM64 installer is listed at https://www.irfanview.com/arm64.htm and follows the
# same naming convention as the x64 installer on the irfanview.info file server.
...
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\Uninstall IrfanView.lnk" -Recurse -Force
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\About IrfanView.lnk" -Recurse -Force
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\Available Languages.lnk" -Recurse -Force
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\Available PlugIns.lnk" -Recurse -Force
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\Command line Options.lnk" -Recurse -Force
Remove-Item -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\IrfanViewARM\IrfanView Help.lnk" -Recurse -Force
