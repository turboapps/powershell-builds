...
$Vendor = "Adobe"
$AppDesc = "Create & Design Sound Effects — Accelerate your video production workflows & audio finishing."
$AppName = "Audition"
...
Expand-Archive -Path $DownloadPath\Audition_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\Audition_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Audition"
