...
$StartupFiles.SelectSingleNode("StartupFile[@node='@APPDATALOCAL@\Microsoft\Teams\Update.exe']").commandLine = ''
$StartupFiles.SelectSingleNode("StartupFile[@node='@APPDATALOCAL@\Microsoft\Teams\Update.exe']").node = '@APPDATALOCAL@\Microsoft\Teams\current\Teams.exe'
