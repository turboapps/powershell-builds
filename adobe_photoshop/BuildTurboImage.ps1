...
$Vendor = "Adobe"
$AppDesc = "Create gorgeous images, rich graphics, and incredible art with Photoshop."
$AppName = "Photoshop"
...
Expand-Archive -Path $DownloadPath\Photoshop_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\Photoshop_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Photoshop"
