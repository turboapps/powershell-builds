...
$Vendor = "Adobe"
$AppDesc = "If you can think it, you can make it with Photoshop CC, the world’s best imaging and design app."
$AppName = "Photoshop"
...
Remove-Item -Path "$DownloadPath\Photoshop_x64_en_US_WIN_64.zip" -Force
