...
$Vendor = "Microsoft"
$AppDesc = "OneNote is a digital note-taking app that lets users create, organize, and sync notes across devices."
$AppName = "OneNote-x64"
$VendorURL = "https://www.onenote.com/"
...
$InstalledVersion = GetVersionFromRegistry "Microsoft 365"
