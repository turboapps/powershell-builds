...
# Edit Startup Files #
######################
## Change the container startup file to ONENOTE.EXE
$StartupFiles = $xappl.Configuration.SelectSingleNode("StartupFiles")
$parentNode = $StartupFiles.SelectNodes("StartupFile[@node='@PROGRAMFILES@\Microsoft Office\Office16\ONENOTE.EXE']")
