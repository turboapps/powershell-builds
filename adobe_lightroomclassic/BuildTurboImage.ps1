...
$Vendor = "Adobe"
$AppDesc = "Adobe Photoshop Lightroom Classic gives you all the desktop editing tools you need to bring out the best in your photos."
...
Expand-Archive -Path $DownloadPath\LightroomClassic_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\LightroomClassic_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Lightroom Classic"
