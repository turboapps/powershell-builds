...
$AppName = "ASP.NET Core Runtime (x64)"
...
$turboCmd = "try winget --isolate=merge -- /C winget install Microsoft.DotNet.AspNetCore.$LatestMajorVer -a x64 --silent --accept-source-agreements"
