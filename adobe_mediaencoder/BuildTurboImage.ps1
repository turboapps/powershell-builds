...
$Vendor = "Adobe"
$AppDesc = "Create optimized video for any screen size and resolution with Adobe Media Encoder."
$AppName = "Media Encoder"
...
Expand-Archive -Path $DownloadPath\MediaEncoder_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\MediaEncoder_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Media Encoder"
