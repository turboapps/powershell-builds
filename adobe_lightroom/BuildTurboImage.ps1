...
$Vendor = "Adobe"
$AppDesc = "With Lightroom for mobile, you can capture, edit, organize, and share photos."
$AppName = "Lightroom"
...
Expand-Archive -Path $DownloadPath\Lightroom_x64_en_US_WIN_64.zip -DestinationPath $DownloadPath
...
$ProcessExitCode = RunProcess "$DownloadPath\Lightroom_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Lightroom"
