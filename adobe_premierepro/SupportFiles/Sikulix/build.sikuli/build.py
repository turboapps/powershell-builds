...
type("premiere")
click(Pattern("select-app.png").targetOffset(161,-1))
click("next-button.png")
click("next-button.png")
...
adobefile_path = os.path.join(os.environ['USERPROFILE'], "Downloads\\PremierePro_x64_en_US_WIN_64.zip")
