...
$Vendor = "R-Project"
$AppDesc = "Rtools is a toolchain bundle used for building R packages from source (those that need compilation of C/C++ or Fortran code) and for build R itself."
$AppName = "RTools"
$VendorURL = "https://cran.r-project.org/bin/windows/Rtools/rtools43/rtools.html"
...
$ProcessExitCode = RunProcess "$DownloadPath\$InstallerName" "/verysilent" $True
