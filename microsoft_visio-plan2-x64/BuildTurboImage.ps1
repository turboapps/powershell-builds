...
$Vendor = "Microsoft"
$AppDesc = "Microsoft Visio diagramming and vector desktop application for Plan 2 subscription."
$AppName = "Visio Plan 2"
...
$InstalledVersion = GetVersionFromRegistry "Microsoft Visio - en-us"
