...
$Vendor = "Adobe"
$AppDesc = "Adobe Bridge is a powerful creative asset manager that lets you preview, organize, edit, and publish multiple creative assets."
$AppName = "Bridge"
...
$ProcessExitCode = RunProcess "$DownloadPath\Bridge_x64\Build\Setup.exe" "--silent" $True
CheckForError "Checking process exit code:" 0 $ProcessExitCode $True # Fail on install error
...
$InstalledVersion = GetVersionFromRegistry "Adobe Bridge"
